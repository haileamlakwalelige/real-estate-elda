      ...
      <div className="bg-secondary text-gray-800">
        <div className="py-10 grid grid-cols-1 lg:grid-cols-2 justify-center items-center px-2 sm:px-4 md:px-12 lg:px-20">
          ...
          <div className="flex flex-col  justify-start items-start">
              ...
              <p className="text-gray-800 text-[14px] md:text-[16px] px-4">This refers to the idea that living in a property offered by Eldana Spring Homes is not just about having a place to stay, but about experiencing something special and distinct.</p>
            </div>
            ...
            <div className="flex flex-col  justify-start items-start">
              ...
              <p className="text-gray-800 text-[14px] md:text-[16px] px-4">This indicates that the properties provided by Eldana Spring Homes are not only luxurious in terms of their design and features but also that every aspect of the property has been meticulously finished with high-quality materials and attention to detail.</p>
            </div>
            ...
            <div className="flex flex-col  justify-start items-start">
              ...
              <p className="text-gray-800 text-[14px] md:text-[16px] px-4">This highlights that the properties offered by Eldana Spring Homes are specifically designed to cater to the needs of families.</p>
            </div>
          </div>
