                ...
                <div className="flex lg:w-1/3 lg:flex-col gap-6 px-4 w-full ">
                    {jsonData.map((item: any) => (
                        <img
                            ...
                            className={`lg:min-h-[118px] lg:min-w-[120px] cursor-pointer ${selectedItem && selectedItem.id === item.id ? ' h-[130px] lg:h-[141px] w-[135px] lg:w-[145px] my-4 rounded-xl' : 'h-[118] lg:w-[120px] w-[110px] rounded-xl hover:scale-105 transform transition-all duration-300'}`}
                        />
                    ))}
                </div>
                <div className="lg:w-2/3">
                    {selectedItem && (
                        <div className="flex lg:flex-row flex-col w-full justify-center gap-10 items-center">
