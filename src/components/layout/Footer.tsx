            ...
            <div className='flex flex-wrap gap-8 items-center justify-center lg:justify-between bg-primary px-2 sm:px-6 md:px-12 lg:px-16 '>
                ...
                <div className='flex justify-start items-center gap-3'>
                    ...
                    <div>
                        ...
                        <p className='my-5 font-semibold text-gray-800'>123 Main Street, Akaki Kality , Addis Ababa Ethiopia.</p>
                        <p className='font-semibold text-gray-800'>info@abcrealestate.com</p>
                    </div>
                </div>
            </div>
