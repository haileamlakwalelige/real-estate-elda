  ...
  return (
    <div  style={{
      ...
      <div className='flex justify-between items-center gap-10 w-screen lg:pr-28'>
        <div>
        <p className='text-normal text-[30px] md:text-[35px] lg:text-[40px] text-gray-800 uppercase'>Our Story</p>
        <div className='flex'>
        ...
        <div className='mt-20 text-gray-800 text-[20px] md:text-[22px] '>
         ...
         <div className='mt-10 hidden xl:flex flex-col items-center justify-start'>
          ...
          <p className='text-gray-800 lg:-mt-40 lg:ml-32 '>Outline the company's vision for the <br/> future, including goals for expansion<br/>, innovation, and continued excellence in <br/> the real estate industry.</p>
         </div>
        </div>
        ...
        <div className='mt-20'>
          ...
          <p className='text-gray-800 lg:-mt-40 lg:ml-32 '>Detail the core values that guide Eldana <br/> Spring Homes in all its endeavors, such <br/> as integrity, professionalism, customer <br/> satisfaction, and a commitment to <br/> quality.</p>
         </div>
         <div className='mt-10 hidden xl:flex flex-col items-center justify-start'>
          <img src={mis} alt='' className='max-h-[300px]'/>
          <p className='text-gray-800 lg:-mt-40 lg:ml-32 '>our mission is to redefine the real estate <br/> experience by providing unparalleled <br/> service, exceptional properties, and <br/> personalized solutions to meet the <br/> diverse needs of our clients.</p>
         </div>
        </div>
       </div>
